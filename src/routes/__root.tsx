  ...
  head: () => ({
    meta: [
      ...
      { title: "Dream Roof UK | London Roofing Specialists" },
      {
        name: "description",
        content:
          "Dream Roof UK — London roofing specialists with 20+ years of experience in slate roofing, flat roofs, repairs, guttering and lead work.",
      },
      { name: "author", content: "Dream Roof UK" },
